...
export const metadata: Metadata = {
  title: "Portfolio 1.0 Internal Platform Iteration",
  description:
    "A separate non-production iteration of the internal platform case study using content from Portfolio 1.0.",
};
...
export default function PortfolioOneInternalPlatformIteration() {
  return (
    <PageBackgroundTransition>
      <section className="container pb-hero pt-16 md:pt-20" data-page-hero>
        <CaseStudyIterationTabs currentHref="/case-study/managing-memberships-at-scale-1-0" />
      ...
      <Section
        ...
        title="The source case study emphasized safer workflows and reusable foundations."
        soft
      >
      ...
      <Section id="overview" eyebrow="Overview" title="This was not just a UI refresh.">
        <div className="grid max-w-4xl gap-content text-6 text-muted-foreground">
      ...
      <Section id="complexity" eyebrow="Complexity" title="The hidden complexity behind simple tasks.">
        <p className="mb-card max-w-4xl text-6 text-muted-foreground">
      ...
      <Section id="design-system" eyebrow="Design system" title="The design system came from real product problems.">
        <div className="grid gap-hero lg:grid-cols-[0.5fr_0.5fr]">
          ...
          <div className="rounded-[1.5rem] bg-surface-soft p-card">
